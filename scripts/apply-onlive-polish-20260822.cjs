...
patchFile('src/MainApp.tsx',[
  ...
  ['<Switch value={tvBrowsing&&!selectedProgram}','<Switch style={Platform.OS===\'ios\'?{transform:[{scaleX:.72},{scaleY:.72},{translateY:1}],marginLeft:-8}:undefined} value={tvBrowsing&&!selectedProgram}','ios glande switch sizing'],
